...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['Plus Jakarta Sans', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'sans-serif'],
      ...
      fontSize: {
        ...
        'lg': ['1.125rem', { lineHeight: '1.7', letterSpacing: '-0.011em' }],
        'xl': ['1.25rem', { lineHeight: '1.7', letterSpacing: '-0.012em' }],
